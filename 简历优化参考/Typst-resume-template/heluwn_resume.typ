// 贺禄文 - 机器人控制与系统调试方向正式简历草稿
// 使用 Tinymist Typst 插件打开后预览并导出 PDF。
// 待补信息集中在顶部信息栏：作品集/个人主页。
// 如需头像版，可将正文内容迁移到 with_profile_picture.typ 的头像布局。

#set page(paper: "a4", margin: (x: 15mm, y: 12mm))
#set text(font: ("Microsoft YaHei", "SimSun"), size: 9.9pt, lang: "zh")
#set par(first-line-indent: 0pt, leading: 0.54em, justify: true)
...
#align(center)[
  ...
  #v(0.1em)
  #text(10.8pt, weight: "bold")[求职意向：机器人控制与系统调试实习 / 机器人硬件与系统集成]
]
